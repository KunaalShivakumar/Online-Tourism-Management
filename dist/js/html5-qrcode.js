 ...
 *
 * @author Package Author <[redacted-email]>
 *
...
class Html5Qrcode {
    ...
    start(cameraIdOrConfig,
        ...
        const setupUi = (width, height) => {
            const qrboxSize = config.qrbox;
            if (qrboxSize > height) {
                // TODO(Package Author): Migrate to common logging.
        ...
        const foreverScan = () => {
            ...
            if ($this._localMediaStream) {
                ...
                $this._context.drawImage(
                    ...
                    // TODO(Package Author): Move this logic to qrcode.js
     ...
     */
    stop() {
        // TODO(Package Author): fail fast if the start() wasn't called.
    ...
    applyVideoConstraints(videoConstaints) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const videoTrack = this._localMediaStream.getVideoTracks()[0];
            // TODO(Package Author): This can be simplified to just return the promise
            // directly.
    ...
    _isMediaStreamConstraintsValid(videoConstraints) {
        ...
        // TODO(Package Author): Make this validity check more sophisticuated
